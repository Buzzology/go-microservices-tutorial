module github.com/buzzology/go-microservices-tutorial/shippy-service-consignment/v0.2
...
require (
	github.com/buzzology/go-microservices-tutorial/shippy-service-vessel v0.2
